...
class RecordBreathFragment : Fragment(){
    ...
    private var _binding: FragmentRecordBreathBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentRecordBreathBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val user = RecordBreathFragmentArgs.fromBundle(arguments as Bundle).user
        ...
        binding.btnKirim.setOnClickListener {
            val toResultFragment =
                RecordBreathFragmentDirections.actionRecordBreathFragmentToResultFragment(user)
